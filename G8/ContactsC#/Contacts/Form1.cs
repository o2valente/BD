...
namespace Contacts
{
    public partial class Form1 : Form
    {
        ...
        private void SubmitContact(Contact C)
        {
            ...
            cmd.CommandText = "INSERT Customers (CustomerID, CompanyName, ContactName, Address, " + "City, Region, PostalCode,Telephone,Fax, Country) " + "VALUES (@CustomerID, @CompanyName, @ContactName, @Address, " + "@City, @Region, @PostalCode,@Telephone,@Fax, @Country) ";
            ...
            cmd.Parameters.AddWithValue("@Telephone", C.tel);
        ...
        private void UpdateContact(Contact C)
        {
            ...
            cmd.CommandText = "UPDATE Customers " + "SET CompanyName = @CompanyName, " + "    ContactName = @ContactName, " + "    Address = @Address, " + "    City = @City, " + "    Region = @Region, " + "    PostalCode = @PostalCode, " + " Telephone = @Telephone, " + " Fax = @Fax, " + "   Country = @Country " + "WHERE CustomerID = @CustomerID";
            cmd.Parameters.Clear();
            cmd.Parameters.AddWithValue("@CustomerID", C.CustomerID);
            cmd.Parameters.AddWithValue("@CompanyName", C.CompanyName);
            cmd.Parameters.AddWithValue("@ContactName", C.ContactName);
