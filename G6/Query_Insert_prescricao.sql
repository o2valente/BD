...
INSERT INTO PRESCRICAO.Paciente(
	numUtente,
	nome,
	dataNasc,
	endereco
...
INSERT INTO PRESCRICAO.Farmacia(
	nome,
	telefone,
	endereco
)
...
INSERT INTO PRESCRICAO.Farmaceutica(
	numReg,
	nome,
	endereco
)
...
INSERT INTO PRESCRICAO.Farmaco(
	numRegFarm,
	nome,
	formula
)
...
VALUES
	(10001,1,105,234370500,'Farmacia Central','2015-03-03'),
	(10002,1,105,NULL,NULL,NULL),
	(10003,3,102,234370500,'Farmacia Central','2015-01-17'),
	(10004,3,101,221234567,'Farmacia BelaVista','2015-02-09'),
	(10005,3,102,234370500,'Farmacia Central','2015-01-17'),
	(10006,4,102,229876543,'Farmacia Vitalis','2015-02-22'),
	(10007,5,103,NULL,NULL,NULL),
	(10008,1,103,234370500,'Farmacia Central','2015-01-02'),
	(10009,3,102,234375111,'Farmacia Peixoto','2015-02-02');

INSERT INTO PRESCRICAO.PrescricaoContemFarmacos(
	numPresc,
	numRegFarm,
	nomeFarmaco
)
