...
drop table PROJETO.TreinadorGuardaRedes
drop table PROJETO.TreinadorAdjunto
drop table PROJETO.TreinadorPrincipal
drop table PROJETO.Treinador
drop table PROJETO.EquipaArbitragem
drop table PROJETO.QuartoArbitro
drop table PROJETO.ArbitroLinha
drop table PROJETO.ArbitroCampo
drop table PROJETO.Arbitro
drop table PROJETO.Vence
drop table PROJETO.Jogo
drop table PROJETO.Jornada
drop table PROJETO.Epoca
drop table PROJETO.Jogador
drop table PROJETO.GrupoAdeptos
drop table PROJETO.Direcao
drop table PROJETO.Pessoa
drop table PROJETO.Clube
drop table PROJETO.Estadio